...
final class PostTaskJni implements PostTask.Natives {
  ...
  public void postDelayedTask(boolean prioritySetExplicitly, int priority, boolean mayBlock,
      boolean useThreadPool, byte extensionId, byte[] extensionData, Runnable task, long delay) {
    N.MTILOhAQ(prioritySetExplicitly, priority, mayBlock, useThreadPool, extensionId, extensionData, task, delay);
  }
