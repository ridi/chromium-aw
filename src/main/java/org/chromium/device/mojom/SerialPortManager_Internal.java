...
GetDevicesResponse callback) {
        ...
        @Override
        public void getPort(
org.chromium.mojo_base.mojom.UnguessableToken token, org.chromium.mojo.bindings.InterfaceRequest<SerialPort> portRequest, SerialPortConnectionWatcher watcher) {
            ...
            try {
                ...
                switch(header.getType()) {
                    ...
                    case GET_PORT_ORDINAL: {
                        ...
                        getImpl().getPort(data.token, data.portRequest, data.watcher);
                        return true;
                    }
