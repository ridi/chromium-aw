...
public final class FormData extends org.chromium.mojo.bindings.Struct {
    ...
    public static FormData decode(org.chromium.mojo.bindings.Decoder decoder0) {
        ...
        try {
            ...
            result = new FormData(elementsOrVersion);
                ...
                result.isFormTag = decoder0.readBoolean(64, 0);
                }
                {
                    
                result.isFormlessCheckout = decoder0.readBoolean(64, 1);
                }
                {
                ...
                result.uniqueRendererId = decoder0.readInt(68);
                }
                {
    ...
    protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
        ...
        encoder0.encode(this.mainFrameOrigin, 56, false);
        
        encoder0.encode(this.isFormTag, 64, 0);
        
        encoder0.encode(this.isFormlessCheckout, 64, 1);
        
        encoder0.encode(this.isGaiaWithSkipSavePasswordForm, 64, 2);
        
        encoder0.encode(this.uniqueRendererId, 68);
