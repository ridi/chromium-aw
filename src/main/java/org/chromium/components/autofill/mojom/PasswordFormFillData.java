...
public final class PasswordFormFillData extends org.chromium.mojo.bindings.Struct {
    ...
    public java.util.Map<org.chromium.mojo_base.mojom.String16, PasswordAndRealm> additionalLogins;
    ...
    public static PasswordFormFillData decode(org.chromium.mojo.bindings.Decoder decoder0) {
        ...
        try {
            ...
            result = new PasswordFormFillData(elementsOrVersion);
                ...
                result.waitForUsername = decoder0.readBoolean(12, 1);
                }
                {
                    
                result.hasRendererIds = decoder0.readBoolean(12, 2);
                }
                {
                ...
                org.chromium.mojo.bindings.Decoder decoder1 = decoder0.readPointer(56, false);
                {
                    ...
                    }
                    {
                        ...
                        org.chromium.mojo.bindings.Decoder decoder2 = decoder1.readPointer(org.chromium.mojo.bindings.DataHeader.HEADER_SIZE + org.chromium.mojo.bindings.BindingsHelper.POINTER_SIZE, false);
                        {
                            ...
                            values0 = new PasswordAndRealm[si2.elementsOrVersion];
                            for (int i2 = 0; i2 < si2.elementsOrVersion; ++i2) {
                                
                                org.chromium.mojo.bindings.Decoder decoder3 = decoder2.readPointer(org.chromium.mojo.bindings.DataHeader.HEADER_SIZE + org.chromium.mojo.bindings.BindingsHelper.POINTER_SIZE * i2, false);
                                values0[i2] = PasswordAndRealm.decode(decoder3);
                            }
                        }
                    }
                    result.additionalLogins = new java.util.HashMap<org.chromium.mojo_base.mojom.String16, PasswordAndRealm>();
    ...
    protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
        ...
        encoder0.encode(this.waitForUsername, 12, 1);
        
        encoder0.encode(this.hasRendererIds, 12, 2);
        ...
        if (this.additionalLogins == null) {
            ...
            PasswordAndRealm[] values0 = new PasswordAndRealm[size0];
            int index0 = 0;
            for (java.util.Map.Entry<org.chromium.mojo_base.mojom.String16, PasswordAndRealm> entry0 : this.additionalLogins.entrySet()) {
