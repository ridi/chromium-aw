...
final class PolicyConverterJni implements PolicyConverter.Natives {
  ...
  public void setPolicyBoolean(long nativePolicyConverter, PolicyConverter caller, String policyKey,
      boolean value) {
    GEN_JNI.org_chromium_policy_PolicyConverter_setPolicyBoolean(nativePolicyConverter, caller, policyKey, value);
  }

  @Override
  public void setPolicyInteger(long nativePolicyConverter, PolicyConverter caller, String policyKey,
      int value) {
    GEN_JNI.org_chromium_policy_PolicyConverter_setPolicyInteger(nativePolicyConverter, caller, policyKey, value);
  }

  @Override
  public void setPolicyString(long nativePolicyConverter, PolicyConverter caller, String policyKey,
      String value) {
    GEN_JNI.org_chromium_policy_PolicyConverter_setPolicyString(nativePolicyConverter, caller, policyKey, value);
  }

  @Override
  public void setPolicyStringArray(long nativePolicyConverter, PolicyConverter caller,
      String policyKey, String[] value) {
    GEN_JNI.org_chromium_policy_PolicyConverter_setPolicyStringArray(nativePolicyConverter, caller, policyKey, value);
  }
